var sqkm_details = function(opts) {
  var _self = {
    ...
    active_tab: null,
    tabs: [
      {index: 0, icon: 'pie', view: 'pie-view'},
      {index: 1, icon: 'line', view: 'line-view'},
    ...
    buildTabsMarkup: function(inner_panel) {            
      ...
      this.tabs_view_wrapper.selectAll('div')
              .data(this.tabs)
              .enter()
              .append('div')
              .style('width', this.view_width + 'px')
              .attr('class',function(d){ return 'tab-view left ' + d.view });
